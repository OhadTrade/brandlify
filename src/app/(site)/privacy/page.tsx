      ...
      <section className="section-y">
        <Container>
          ...
          <Prose>
            ...
            <p>
              האתר בנוי כך שאפשר להפעיל בו מדידה סטטיסטית באמצעות Google Analytics, שנועדה להבין
              אילו עמודים נצפים וכמה זמן. מידע כזה מצטבר ואינו מיועד לזהות אותך אישית, וניתן לחסום
              אותו בהגדרות הדפדפן או באמצעות תוסף החסימה הרשמי של גוגל. נכון למועד עדכון מסמך זה
              המדידה אינה מופעלת בפועל, ולא נטענים סקריפטים של גוגל בעמודי האתר. אם וכאשר תופעל,
              נעדכן כאן.
            </p>
            <p>
              <strong>איננו שומרים את כתובת ה־IP שלך יחד עם הפנייה.</strong> כתובת ה־IP מוחזקת
              בזיכרון השרת בלבד, עד שעה, לצורך הגבלת מספר השליחות מאותו מקור, ואינה נכתבת לבסיס
              הנתונים. ההגנה מפני שליחות אוטומטיות נעשית באמצעות Cloudflare Turnstile, שירות שנועד
              להבחין בין אדם לרובוט בלי לעקוב אחריך בין אתרים.
            </p>
