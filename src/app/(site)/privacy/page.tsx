      ...
      <section className="section-y">
        <Container>
          ...
          <Prose>
            ...
            <h3>3. הסכמה לדיוור פרסומי</h3>
            <p>
              בטופס יש תיבת סימון נפרדת ואופציונלית לקבלת דיוור פרסומי — טיפים, מדריכים ומבצעים.
              היא איננה תנאי לקבלת מענה, והיא נפרדת לחלוטין מההסכמה לחזור אליך בעקבות הפנייה.
              אם סימנת אותה, נשמר אצלנו תיעוד של ההסכמה ומועדה.
            </p>
            <p>
              בכל הודעה פרסומית שנשלח יופיע קישור הסרה בלחיצה אחת, וגם אפשרות הסרה דרך תוכנת הדואר
              שלך. הסרה נכנסת לתוקף מיד ואינה משפיעה על תשובות לפניות שאתה שולח לנו או על התכתבות
              בנוגע לעבודה קיימת.
            </p>
